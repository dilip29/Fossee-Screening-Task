...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuManage_Teams.setTitle(_translate("MainWindow", "Manage Steels"))
        self.actionNEW_Team.setText(_translate("MainWindow", "NEW Steel"))
        self.actionOPEN_Team.setText(_translate("MainWindow", "OPEN Steel"))
        self.actionSAVE_Team.setText(_translate("MainWindow", "SAVE Steel"))
        self.actionEVALUATE_Team.setText(_translate("MainWindow", "EVALUATE Steel"))
    ...
    def menu(self,action):
        ...
        if txt=='NEW Steel':
            ...
            #self.dial()
            text, ok=QtWidgets.QInputDialog.getText(MainWindow, "Team", "Enter name of Steel to be Added:")
            if ok:
